...
- **Store-switch relocation (2026-09-21, fourth batch) — complete:** the admin's Amara/Zeann switch was removed from every page top (credit detail, inventory, receiving, riders, vehicles, expenses) and lives once on the admin More page under "Store context" (DEC-040); all admin pages follow that context, and staff remain store-locked with no switch.
